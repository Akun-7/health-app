...
import { IconHistory, IconChartLine, IconBell, IconSettings, IconAlertTriangle, IconStethoscope, IconWalk, IconMenu2 } from '@tabler/icons-react-native';
...
type Props = MainScreenProps<'Dashboard'>;
